...
<div class="wrap">
	<div class="postbox-container">
		<form method="post" action="options.php" class="postbox" style="margin: 10px">
			...
			<?php $wp_rest_cache_serve_flushed_cache = \WP_Rest_Cache_Plugin\Includes\Caching\Caching::get_instance()->should_serve_until_regenerated(); ?>
			...
			<table class="form-table" style="margin: 0 12px">
				...
				<tr>
					<th><?php esc_html_e( 'Serve from cache until regenerated', 'wp-rest-cache' ); ?></th>
					<td>
						<input type="checkbox" value="1"
							name="wp_rest_cache_serve_flushed_cache" <?php echo $wp_rest_cache_serve_flushed_cache ? 'checked="checked"' : ''; ?>>
						<p class="description"
							id="wwp_rest_cache_serve_flushed_cache-description"><?php esc_html_e( 'Serve old cache value until fully regenerated by the cron.', 'wp-rest-cache' ); ?></p>
					</td>
				</tr>
				<?php
